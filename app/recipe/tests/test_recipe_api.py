...
class RecipeImageUploadTests(TestCase):
    ...
    def test_fileter_recipes_by_tags(self):
        """Test returning receipes with specific tags"""
        recipe1 = sample_recipe(user=self.user, title='Thai vegetable curry')
        recipe2 = sample_recipe(user=self.user, title='Abergin wiht tahini')
        tag1 = sample_tag(user=self.user, name='Vegan')
    ...
    def test_filter_recipes_by_ingredients(self):
        """Test returning receipes with specific ingredients"""
